...
(<div className="col-3">
        ...
        <img className="card-img-top" src={imageUrl} alt={"Image of " + countryName} />
            ...
            {temperatureDataYearRange[0] !== 0 && <Link to={"/Country/CountryTemperatureDetail/" +regionId +"/"+ countryId} className="btn btn-primary ">View Country Temperature {temperatureDataYearRange[0]} - {temperatureDataYearRange[1]}</Link>}
