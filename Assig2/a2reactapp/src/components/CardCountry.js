...
(<div className="col-3">
        ...
        <img className="card-img-top" src={imageUrl} alt={"Image of " + countryName} />
            ...
            {cityCount !== 0 && <Link to={"/City/" + countryId} className="btn btn-info mt-2" state={{ countryName: countryName, countryImage: imageUrl, regionName: regionName, regionId: regionId }}>View Cities</Link>}
            </div>
        </div>
    </div>
)
