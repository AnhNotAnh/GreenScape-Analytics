...
(<div className="col-3">
        ...
        <img className="card-img-top" src={imageUrl} alt={"Image of " + countryName} />
            ...
            <Link to={"/Country/CountryTemperatureDetail"} className="btn btn-primary ">View Country Tempeture Detail</Link>
            <Link to={"/Country/CountryEmissionDetail"} className="btn btn-warning mt-2 ">View Country Emission Detail</Link>
